...
The code is divided into multiple folders. Each folder allows you to reproduce the same results and figures as in the paper. The same scripts can also be customized to apply the optimization and control methods presented in the paper to arbitrary networks of Kuramoto oscillators.
